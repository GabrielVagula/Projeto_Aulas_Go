...
function curtirPublicacao(evento) {
    ...
    const publicacaoId = elementoClicado.closest('div[data-publicacao-id]').data('publicacao-id');
    ...
    $.ajax({
        ...
        let quantidadeDeCurtidas = parseInt(contadorDeCurtidas.text());
...
function deletarPublicacao(evento) {
    ...
    Swal.fire({
        title: "Atenção!",
        text: "A publicação sera excluída!          Você tem certeza disso?",
        ...
        const publicacao = elementoClicado.closest('div[data-publicacao-id]');
