...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	// No final da func PararDeSeguirUsuario no seu controller Go
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("Senha Atual:", r.FormValue("atual"))
	fmt.Println("Nova Senha:", r.FormValue("nova"))
...
// DeletarUsuario chama a API para deletar um usuário do banco de dados.
