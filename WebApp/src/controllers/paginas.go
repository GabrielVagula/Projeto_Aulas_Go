...
// CarregarPaginaDeUsuarios carrega o filtro feito pelo o usuário.
func CarregarPaginaDeUsuarios(w http.ResponseWriter, r *http.Request) {

	nomeOuNick := r.URL.Query().Get("usuario")

	url := fmt.Sprintf("%s/usuarios?usuario=%s", config.APIURL, url.QueryEscape(nomeOuNick))
...
// CarregarPaginaDeUsuarios carrega a página do perfil do usuario.
...
// CarregarPerfilDoUsuarioLogado carrega a página do perfil do usuario logado.
...
// CarregarPaginaDeEdicaoDeUsuario carrega a página de edição do usuario logado.
...
// CarregarPaginaDeAtualizacaoDeSenha carrega para atualização da senha do usuário.
