...
// Busca um usuario em especifico no banco de dados.
...
// Altera/Altualiza os dados do usuario.
...
// Permite que o usuario siga os outros dentro da rede social.
...
// Permite que o usuario pare de seguir aquele usuario que ele segue.
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não foi possível parar de seguir você mesmo"))
		return
	}
...
func BuscarSeguindo(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Printf("ID pesquisado: %d\n", usuarioID)
	fmt.Printf("Quantidade que esta seguindo encontrados no banco é: %d\n", len(usuarios))
	fmt.Println("Conteúdo da slice:", usuarios)
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível atuailizar a senha que não seja o seu"))
		return
	}
	...
	fmt.Println("Passou pela autenticação")
	...
	fmt.Println("Vai buscar a senha...")

	senhaSalvaNoBanco, erro := repositorio.BuscarSenha(usuarioID)
	if erro != nil {
		fmt.Println("Erro ao buscar senha:", erro)
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
