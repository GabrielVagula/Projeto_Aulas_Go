...
// Criar inser uma publicação no banco de dados.
...
// Buscar traz as publicações do usuario seguidos e o proprio usuario que fez a requisição
...
// Deletar exclui o dado selecionado do banco de dados.
...
// Curtir adicona uma curtida na publicação escolhida;
